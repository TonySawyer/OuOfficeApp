    ...
    $.fn.Dropdown = function () {
        ...
        return this.each(function () {
            ...
            var $dropdownWrapper = $(this),
                ...
                newDropdownItems = '',
                newDropdownSource = '';
            var newDropDownId = $originalDropdown.attr('id')+'_replacement';
            ...
            newDropdownSource = '<span class="ms-Dropdown-title" id="' + newDropDownId + '">' + newDropdownTitle + '</span><ul class="ms-Dropdown-items">' + newDropdownItems + '</ul>';
